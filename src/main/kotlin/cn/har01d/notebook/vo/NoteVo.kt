...
fun Note.toVo() = NoteVO(rid, content!!.title, content!!.content, author.toVo2(), notebook.toVo2(), category.toVo2(), content!!.markdown, access, content!!.version, createdTime, updatedTime)
