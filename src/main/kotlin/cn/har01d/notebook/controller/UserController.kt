...
class UserController(
    ...
    @GetMapping("/{id}/notes")
    fun getUserNotes(@PathVariable id: String, pageable: Pageable) = noteService.getUserNotes(id, pageable).map { it.toVo2() }
    ...
    fun getUserNotebooks(@PathVariable id: String, pageable: Pageable) = notebookService.getUserNotebooks(id, pageable).map { it.toVo() }
